            ...
            <div className={styles.content}>
                <div className={styles.textContent}>
                    ...
                    <div className={styles.description}>
                        <p>1995年生まれです。社会人4年目で会社を退職し、27歳で日本に来ました。
                        </p>
                        <p>もともとものづくりが好きで、中国での4年間の社会人経験では、環境デザイン、グラフィックデザイン、映像編集に関わる仕事をしていました。</p>
                        ...
                        <p>Webデザイン学科を選んだ理由は、新しいWeb分野の知識に触れたいという気持ちと、これまでのデザイン経験を活かせると考えたからです。そして将来は、自分が満足できるWebサイトを作りたいと思っています。</p>
                        <p>現在は、恵まれた学習環境と家族の支えに感謝しながら、日々新しい技術を学び、自身の成長を実感しています。</p>
                    </div>
                </div>
